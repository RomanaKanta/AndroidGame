...
import com.example.romana.simplegame.HexGrid.misc.HexPoint2D;
import com.example.romana.simplegame.HexGrid.misc.HexPosition;
import com.example.romana.simplegame.HexGrid.misc.HexRect2D;
import com.example.romana.simplegame.HexGrid.renders.HexEngineRender;
...
/**
 * A Custom View example to show possibility of HexGridActivity (https://code.google.com/p/jhexed/) usage with Android.
 */
public class JHexedPhotoView extends View implements HexEngineRender<Canvas> {
     ...
     */
    private int hexEdgeColor;

    /**
     * The Color of border of a selected hex cell.
     */
    private int hexSelectedEdgeColor;
     ...
     */
    private Bitmap[] iconsOptimizedForHexagons;
    /**
     * The Hexagonal Path.
     */
...
//        try {
//            this.cellWidth = typedArray.getInt(R.styleable.JHexedPhotoView_cellWidth, 100);// cell width
//            this.cellHeight = typedArray.getInt(R.styleable.JHexedPhotoView_cellHeight, 150);// cell height
//            this.fieldWidth = typedArray.getInt(R.styleable.JHexedPhotoView_fieldWidth, 5); //row number
//            this.fieldHeight = typedArray.getInt(R.styleable.JHexedPhotoView_fieldHeight, 5);//column number
...
//            this.hexLineWidth = typedArray.getFloat(R.styleable.JHexedPhotoView_hexLineWidth, 5.0f);
//        } finally {
//            typedArray.recycle();
//        }
