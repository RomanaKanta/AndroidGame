...
import com.example.romana.simplegame.HexGrid.renders.NullHexRender;
import com.example.romana.simplegame.HexGrid.misc.*;
import java.util.*;
...
public final class HexEngine<G> {
   ...
   */
  private HexEngineRender<G> renderer = new NullHexRender<>();
  /**
