...
public class GridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(item.getFace() == GridViewItem.ItemFace.FRONT){ // Showing the front of the card
            ...
            ImageView gridItemImage = (ImageView) holder.holderView.findViewById(R.id.grid_view_item_image);
            gridItemImage.setImageResource(item.getmImage());
        }
    ...
    private void reset(){
       ...
       for (int i=0; i<mList.size(); i++){
           mList.get(i).setFace(GridViewItem.ItemFace.FRONT);
       }
    ...
    private void flipGridViewItem(final View v, GridViewItem item){
        ...
        if(item.getFace() == GridViewItem.ItemFace.FRONT){
            ...
            ImageView gridItemImage = (ImageView) v.findViewById(R.id.grid_view_item_image);
            gridItemImage.setImageResource(item.getmImage());
